...
public class StudentPage extends AbstractPage {
    ...
    public StudentPage checkStudentHeader(String studentsHeader) {
        Assert.assertEquals(studentsHeaderActual.getText(), studentsHeader);
        return this;
    }

    public StudentPage checkMenuOnTheLeft(List<String> expectedListMenuOnTheLeft) {
    ...
    public StudentPage checkStudentsLink(String expectedStudentsLink) {
        try {
            Thread.sleep(5000);
